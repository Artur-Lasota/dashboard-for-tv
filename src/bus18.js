...
const bus18 = (callback) => {
  var hour;
  var minute = [];
  var busData = [];

  request('https://www.komunikacja.bialystok.pl/?page=przystanek&nrl=18&nrp=200&k=1&rozklad=', function (error, response, html) {
